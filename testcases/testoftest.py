...
def Variables(variable_line):
    ...
    return variables_count, typedict, casing_ratio
...
#
    ...
    # dont forget to set typedict of all types I am gonna count to zero (create list/iterate/typedict[i]=0)
    #typedict["Numbers"] = typedict["Long"] + typedict["Integer"]
    #typedict["Alphabet"] = typedict["String"] + typedict["Word.Paragraph"]
